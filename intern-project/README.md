...
Login to the [Cloudflare Dashboard](https://dash.cloudflare.com) and go to `User Profile` -> `API Tokens` or click this [link](https://dash.cloudflare.com/profile/api-tokens).  
Click `Create Token`.\
...
Click `Continue to summary` and `Create Token`. Save this API Token somewhere safe.

You now have your API Token to use!

## Getting your Zone ID

Login to the [Cloudflare Dashboard](https://dash.cloudflare.com) and go to `Websites` and select the Zone you would like to inspect.\
